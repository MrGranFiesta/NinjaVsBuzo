...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    {
        Debug.Log("Launcher - OnMasterClientSwitched");
        startGameButton.SetActive(PhotonNetwork.IsMasterClient);
    }
    ...
    {
        Debug.Log("Launcher - OnCreateRoomFailed");
